...
object MessageUtils {
  /** Sanitise a message such that all mentions become inactive, including
    ...
    *
    * @param message text to sanitise
  ...
  /** Sanitise a message such that all formatting becomes plaintext when viewed
    * by the official Discord client.
    *
    * @param message text to sanitise
    * @return sanitised text
    */
  ...
  /** Sanitise a message such that all formatting and mentions become
    * plaintext when viewed by the official Discord client.
    *
    * @param message text to sanitise
    * @return sanitised text
    */
  ...
  /** Sanitise a message such that it contains no way to break out of
    * double-backtick (or triple-backtick) code blocks.
    *
    * @param message text to sanitise
    * @return sanitised text
    */
